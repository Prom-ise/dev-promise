...
export const Navbar = ({ currentTrophy, unlockAchievement, showLastNotification }) => {
  const [showNavBar, setShowNavBar] = useState(false);
  const [theme, setTheme] = useState("dark-theme");
  const [colorTheme, setColorTheme] = useState("red-theme");
  const [indicatorLeft, setIndicatorLeft] = useState(14); // Initial position for the indicator
  ...
  return (
    <div className="navbar">
      <div className="flex items-center" data-aos="flip-right">
        ...
        <div>
          ...
          >
            <MenubarMenu>
              <MenubarTrigger
                className="trigger custom-trigger data-[state=open]:!text-[var(--mainColor)] data-[state=closed]:!text-[var(--mainColor)] !ring-0 !shadow-none dark:!border-none !border-none !border-transparent !bg-transparent !p-1 rounded-full text-3xl text-[var(--mainColor)]"
              >
              ...
              <MenubarItem className="custom-item focus:!bg-transparent">
                ...
                <MenubarItem className="custom-item !bg-transparent" onClick={() => changeColorTheme("red-theme")}>
                  <div className="redTheme"></div>
                </MenubarItem>
                <MenubarItem className="custom-item !bg-transparent" onClick={() => changeColorTheme("blue-theme")}>
                <div className="blueTheme"></div>
                </MenubarItem>
                <MenubarItem className="custom-item !bg-transparent" onClick={() => changeColorTheme("yellow-theme")}>
                <div className="yellowTheme"></div>
                </MenubarItem>
                <MenubarItem className="custom-item !bg-transparent" onClick={() => changeColorTheme("lime-theme")}>
      ...
      {/* Trophy display */}
      <div className="trophy-display" onClick={showLastNotification} style={{ cursor: "pointer" }}>
        <img src={trophyImages[currentTrophy]} alt={`${currentTrophy} Trophy`} />
      </div>
      </div>
      ...
      <li>
        <NavLink to="/Dev_Promise" className={({ isActive }) => (isActive ? "nav-iconed" : "nav-icon")}>
      ...
      <li>
        <NavLink to="/about" className={({ isActive }) => (isActive ? "nav-iconed" : "nav-icon")}>
          <div className="tooltip-container">
            <FaUserAlt />
      ...
      <li>
        <NavLink to="/projects" className={({ isActive }) => (isActive ? "nav-iconed" : "nav-icon")}>
          <div className="tooltip-container">
            <GrProjects />
      ...
      <li>
        <NavLink to="/contact" className={({ isActive }) => (isActive ? "nav-iconed" : "nav-icon")}>
          <div className="tooltip-container">
            <AiFillMessage />
        ...
        <div className="small-trophy-display" onClick={showLastNotification} style={{ cursor: "pointer" }}>
        <img src={trophyImages[currentTrophy]} alt={`${currentTrophy} Trophy`} />
      </div>
