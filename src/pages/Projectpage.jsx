...
const Projectpage = ({ unlockAchievement }) => {
  ...
  return (
    <div className="projects">
      ...
      <div className="pro-ject flex flex-wrap items-center justify-center" data-aos="fade-left">
        <div className="space-up lg:w-6/12 md:w-6/12 flex-grow basis-[200]">
          ...
          <p className="project-infom">
            This is a site for documents manager, I was inspired by a
            design I found on Figma so I decided to try it out.
          </p>
          <ul className="list">
            <li>HtML</li>
            <li>CSS</li>
          ...
          <div className="flex gap-[1em] items-center mt-3">
            <div>
            <a href="https://block-vault-mu.vercel.app" target="_blank" rel="noopener noreferrer">
              <button
                type="submit"
            ...
            <div>
            <a href="https://github.com/Prom-ise/BlockVault" target="_blank" rel="noopener noreferrer">
      ...
      <div className="pro-jects flex flex-wrap items-center justify-between" data-aos="fade-right">
        <div className="space-up lg:w-6/12 md:w-6/12 flex-grow basis-[200]">
          <h1 className="project-name">Color Picker</h1>
          <p className="project-infom">
          A dynamic color picker tool that allows users to select, customize, and apply colors effortlessly. Designed to enhance user experience with an intuitive interface and seamless integration into various projects.
          </p>
          <ul className="list">
            <li>HtML</li>
            <li>CSS</li>
          ...
          <div className="flex gap-[1em] items-center mt-3">
            <div>
            <a href="https://color-picker-three-ruddy.vercel.app" target="_blank" rel="noopener noreferrer">
            <button
                type="submit"
                className="flex justify-center gap-2 items-center shadow-xl text-[var(--textColor)] text-lg bg-black-500 backdrop-blur-md lg:font-semibold isolation-auto border-[var(--mainColor)] before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-[var(--mainColor)] hover:text-[var(--textColor)] before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 px-4 py-2 overflow-hidden border-2 rounded-full group"
                style={{borderColor: 'var(--mainColor)'}}
            ...
            <div>
            <a href="https://github.com/Prom-ise/Color-Picker" target="_blank" rel="noopener noreferrer">
              <button className="git-button">
                <svg
                  width="24"
                  height="24"
      ...
      <div className="pro-ject flex flex-wrap items-center justify-center" data-aos="fade-left">
        <div className="space-up lg:w-6/12 md:w-6/12 flex-grow basis-[200]">
          ...
          <p className="project-infom">
          A responsive restaurant website featuring interactive menus, reservation capabilities, and an engaging user experience for exploring dishes and special offers.
          </p>
          <ul className="list">
            <li>HtML</li>
            <li>CSS</li>
      ...
      <div className="pro-jects flex flex-wrap items-center justify-center" data-aos="fade-right">
        <div className="space-up lg:w-6/12 md:w-6/12 flex-grow basis-[200]">
          <h1 className="project-name">Keep Tasks</h1>
          <p className="project-infom">
          A task management application integrated with Firebase, allowing users to securely create, update, and organize tasks across devices.
          </p>
      ...
      <div className="pro-ject flex flex-wrap items-center justify-center" data-aos="fade-left">
        <div className="space-up lg:w-6/12 md:w-6/12 flex-grow basis-[200]">
          ...
          <p className="project-infom">
          An interactive and engaging web-based Tic-Tac-Toe game featuring smart AI for competitive play and a polished user interface for a fun gaming experience
          </p>
          <ul className="list">
            <li>HtML</li>
            <li>CSS</li>
          ...
          <div className="flex gap-[1em] items-center mt-3">
            <div>
            <a href="https://tictactoe-max.vercel.app" target="_blank" rel="noopener noreferrer">
              <button
                type="submit"
                className="flex justify-center gap-2 items-center shadow-xl text-[var(--textColor)] text-lg bg-black-500 backdrop-blur-md lg:font-semibold isolation-auto border-[var(--mainColor)] before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-[var(--mainColor)] hover:text-[var(--textColor)] before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 px-4 py-2 overflow-hidden border-2 rounded-full group"
                style={{borderColor: 'var(--mainColor)'}}
            ...
            <div>
            <a href="https://github.com/Prom-ise/TicTacToe" target="_blank" rel="noopener noreferrer">
              <button className="git-button">
                <svg
                  width="24"
                  height="24"
      ...
      <div className="pro-jects flex flex-wrap items-center justify-center" data-aos="fade-right">
        <div className="space-up lg:w-6/12 md:w-6/12 flex-grow basis-[200]">
          ...
          <p className="project-infom">
          An advanced calculator capable of performing basic arithmetic operations as well as more complex calculations such as squares, square roots, trigonometric functions (tan, cos, sin), and percentages, all in an easy-to-use interface.
          </p>
          <ul className="list">
            <li>HtML</li>
            <li>CSS</li>
          ...
          <div className="flex gap-[1em] items-center mt-3">
            <div>
            <a href="https://calculator-xupn.vercel.app" target="_blank" rel="noopener noreferrer">
            <button
                type="submit"
                className="flex justify-center gap-2 items-center shadow-xl text-[var(--textColor)] text-lg bg-black-500 backdrop-blur-md lg:font-semibold isolation-auto border-[var(--mainColor)] before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-[var(--mainColor)] hover:text-[var(--textColor)] before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 px-4 py-2 overflow-hidden border-2 rounded-full group"
                style={{borderColor: 'var(--mainColor)'}}
            ...
            <div>
            <a href="https://github.com/Prom-ise/Calculator" target="_blank" rel="noopener noreferrer">
              <button className="git-button">
                <svg
                  width="24"
                  height="24"
      ...
      <div className="pro-ject flex flex-wrap items-center justify-center" data-aos="fade-left">
        <div className="space-up lg:w-6/12 md:w-6/12 flex-grow basis-[200]">
          ...
          <p className="project-infom">
          A modern e-commerce platform designed for seamless product browsing, secure checkout, and easy management with responsive design and real-time functionality.
          </p>
          <ul className="list">
            <li>HtML</li>
            <li>CSS</li>
      ...
      <div className="pro-jects flex flex-wrap items-center justify-center" data-aos="fade-right">
        <div className="space-up lg:w-6/12 md:w-6/12 flex-grow basis-[200]">
          ...
          <p className="project-infom">
          A professional showcase of projects and skills, built with a modern and responsive design, demonstrating a range of web development capabilities including interactive elements and theme management.
          </p>
          <ul className="list">
            <li>REACT</li>
            <li>SCSS</li>
      ...
      <div className="pro-ject flex flex-wrap items-center justify-center" data-aos="fade-left">
        <div className="space-up lg:w-6/12 md:w-6/12 flex-grow basis-[200]">
          ...
          <p className="project-infom">
          A dynamic weather application that fetches real-time weather data based on both user location and manually entered locations. It provides current conditions and forecasts in a clear and user-friendly interface, making it easy to check weather details anytime, anywhere.
          </p>
          <ul className="list flex gap-[2em]">
            <div>
            <li>HtML</li>
          ...
          <div className="flex gap-[1em] items-center mt-3">
            <div>
            <a href="https://weather-app-henna-delta.vercel.app" target="_blank" rel="noopener noreferrer">
            <button
                type="submit"
                className="flex justify-center gap-2 items-center shadow-xl text-[var(--textColor)] text-lg bg-black-500 backdrop-blur-md lg:font-semibold isolation-auto border-[var(--mainColor)] before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-[var(--mainColor)] hover:text-[var(--textColor)] before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 px-4 py-2 overflow-hidden border-2 rounded-full group"
                style={{borderColor: 'var(--mainColor)'}}
            ...
            <div>
            <a href="https://github.com/Prom-ise/Weather-App" target="_blank" rel="noopener noreferrer">
              <button className="git-button">
                <svg
                  width="24"
                  height="24"
      ...
      <div className="pro-jects flex flex-wrap items-center justify-center" data-aos="fade-right">
        <div className="space-up lg:w-6/12 md:w-6/12 flex-grow basis-[200]">
          ...
          <p className="project-infom">
          A powerful todo list application with features such as task creation, editing, completion tracking, and user authentication. It integrates Firebase for secure data storage and synchronization across devices.
          </p>
          <ul className="list flex gap-[2em]">
            <div>
            <li>REACT</li>
          ...
          <div className="flex gap-[1em] items-center mt-3">
            <div>
            <a href="https://todolist-client-0nr0.onrender.com" target="_blank" rel="noopener noreferrer">
            <button
                type="submit"
                className="flex justify-center gap-2 items-center shadow-xl text-[var(--textColor)] text-lg bg-black-500 backdrop-blur-md lg:font-semibold isolation-auto border-[var(--mainColor)] before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-[var(--mainColor)] hover:text-[var(--textColor)] before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 px-4 py-2 overflow-hidden border-2 rounded-full group"
                style={{borderColor: 'var(--mainColor)'}}
            ...
            <div>
            <a href="https://github.com/Prom-ise/todoList-client" target="_blank" rel="noopener noreferrer">
              <button className="git-button">
                <svg
                  width="24"
                  height="24"
      ...
      <div>
      <div className="text-2xl mt-[4em] mb-[1em] text-[var(--mainColor)]" data-aos="fade-right">Other Projects</div>
      <div className="project-card-group mb-[3em]">
          <div className="projects-card" data-aos="zoom-in" data-aos-delay="100">
            ...
            <div className="bottom-section">
              ...
              Explore population data and fun facts about every country worldwide.
              </div>
              <div className="row row1">
                ...
                <div className="item">
                <a href="https://country-s-data.vercel.app" target="_blank" rel="noopener noreferrer">
                  <span className="big-texts">Explore</span>
                  </a>
                  <a href="https://github.com/Prom-ise/Country-s-Data" target="_blank" rel="noopener noreferrer">
          ...
          <div className="projects-card" data-aos="zoom-in" data-aos-delay="200">
            <div className="top-section">
            ...
            <div className="bottom-section">
              ...
              <div className="card-info">
              A sleek landing page design portfolio for aspiring web developers.
              </div>
              <div className="row row1">
                <div className="item">
                  <span className="big-text">Frontend</span>
                ...
                <div className="item">
                <a href="https://web-portfolio-prototype.vercel.app" target="_blank" rel="noopener noreferrer">
                  <span className="big-texts">Explore</span>
                  </a>
                  <a href="https://github.com/Prom-ise/web-portfolio-prototype" target="_blank" rel="noopener noreferrer">
                  <span className="regular-texts">View code</span>
                  </a>
                </div>
              </div>
          ...
          <div className="projects-card" data-aos="zoom-in" data-aos-delay="300">
            <div className="top-section">
            ...
            <div className="bottom-section">
              ...
              <div className="card-info">
              A modern landing page for a comprehensive school management system.
              </div>
              <div className="row row1">
                <div className="item">
                  <span className="big-text">Frontend</span>
                ...
                <div className="item">
                <a href="https://my-ca-test-1.vercel.app" target="_blank" rel="noopener noreferrer">
                  <span className="big-texts">Explore</span>
                  </a>
                  <a href="https://github.com/Prom-ise/My-CA-TEST-1" target="_blank" rel="noopener noreferrer">
                  <span className="regular-texts">View code</span>
                  </a>
                </div>
              </div>
        ...
        <div className="project-card-group my-[3em]">
          <div className="projects-card" data-aos="zoom-in" data-aos-delay="100">
            ...
            <div className="bottom-section">
              ...
              <div className="card-info">
              Calculate love compatibility by inputting two names for a fun percentage result.
              </div>
              <div className="row row1">
                <div className="item">
                  <span className="big-text">Frontend</span>
                ...
                <div className="item">
                <a href="https://love-calculator-rose.vercel.app" target="_blank" rel="noopener noreferrer">
                  <span className="big-texts">Explore</span>
                  </a>
                  <a href="https://github.com/Prom-ise/love-calculator" target="_blank" rel="noopener noreferrer">
                  <span className="regular-texts">View code</span>
                  </a>
                </div>
              </div>
          ...
          <div className="projects-card" data-aos="zoom-in" data-aos-delay="200">
            ...
            <div className="bottom-section">
              ...
              <div className="row row1">
                ...
                <div className="item">
                <a href="https://zion-graphics.vercel.app" target="_blank" rel="noopener noreferrer">
                  <span className="big-texts">Explore</span>
                  </a>
                  <a href="https://github.com/Prom-ise/Zion-Graphics" target="_blank" rel="noopener noreferrer">
                  <span className="regular-texts">View code</span>
                  </a>
                </div>
              </div>
          ...
          <div className="projects-card" data-aos="zoom-in" data-aos-delay="300">
            ...
            <div className="bottom-section">
              ...
              <div className="row row1">
                ...
                <div className="item">
                <a href="https://grading-score.vercel.app" target="_blank" rel="noopener noreferrer">
                  <span className="big-texts">Explore</span>
                  </a>
                  <a href="https://github.com/Prom-ise/Grading-Score" target="_blank" rel="noopener noreferrer">
                  <span className="regular-texts">View code</span>
                  </a>
                </div>
              </div>
          ...
          <div className="projects-card" data-aos="zoom-in" data-aos-delay="100">
            ...
            <div className="bottom-section">
              ...
              <div className="row row1">
                ...
                <div className="item">
                <a href="https://vanlife-rct.vercel.app" target="_blank" rel="noopener noreferrer">
                  <span className="big-texts">Explore</span>
                  </a>
                  <a href="https://github.com/Prom-ise/vanlife-rct" target="_blank" rel="noopener noreferrer">
                  <span className="regular-texts">View code</span>
                  </a>
                </div>
              </div>
          ...
          <div className="projects-card" data-aos="zoom-in" data-aos-delay="200">
            ...
            <div className="bottom-section">
              ...
              <div className="row row1">
                ...
                <div className="item">
                <a href="https://ibadan-tech-expo-psi.vercel.app" target="_blank" rel="noopener noreferrer">
                  <span className="big-texts">Explore</span>
                  </a>
                  <a href="https://github.com/Prom-ise/ibadan-tech-expo" target="_blank" rel="noopener noreferrer">
                  <span className="regular-texts">View code</span>
                  </a>
                </div>
              </div>
          ...
          <div className="projects-card" data-aos="zoom-in" data-aos-delay="300">
            ...
            <div className="bottom-section">
              ...
              <div className="row row1">
                ...
                <div className="item">
                <a href="https://project-1-0-eight.vercel.app" target="_blank" rel="noopener noreferrer">
                  <span className="big-texts">Explore</span>
                  </a>
                  <a href="https://github.com/Prom-ise/Project-1.0" target="_blank" rel="noopener noreferrer">
                  <span className="regular-texts">View code</span>
                  </a>
                </div>
              </div>
      ...
      <div className="nextPageText !mb-[-2em] !mt-[1em]" data-aos="fade-up" data-aos-delay="500">
  "Impressed with what you see? Let's collaborate or discuss how I can help with your next project. <span className="text-[var(--mainColor)] underline hover:text-[var(--shadowColor7)] cursor-pointer"><NavLink to="/contact">Get in touch</NavLink></span> and let's make something great together!"
</div>
    </div>
  );
};
